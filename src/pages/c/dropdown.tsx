import { Card, Code, Dropdown, Element, Heading } from '@cosmo-au/design-system';
...
function PagesComponentsDropdown() {
  ...
  return (
    <Layout
      ...
      github='https://github.com/cosmo-au/design-system/blob/main/src/components/Dropdown/Dropdown.tsx'
      name='Dropdown'
      parent='Components'>
      <Element bottom={10} id='start'>
        ...
        <Code copy>{"import { Dropdown } from '@cosmo-au/design-system';"}</Code>
      </Element>
