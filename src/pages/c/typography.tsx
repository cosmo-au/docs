...
import { Card, Code, Element, Heading, Text } from '@cosmo-au/design-system';
  ...
  return (
    <Layout
      ...
      <Element bottom={10} id='start'>
        ...
        <Code copy>{"import { Heading, Text } from '@cosmo-au/design-system';"}</Code>
      </Element>
      ...
      <Element bottom={10} id='inline'>
        ...
        <Code copy>{'<Heading level={3} inline inlineSpacer={5}>inline heading</Heading>\n' + '<Heading level={4} inline>also inline heading</Heading>'}</Code>
      </Element>
