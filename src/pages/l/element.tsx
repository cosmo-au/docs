    ...
    <Layout
      ...
      <Element bottom={10} id='start'>
        ...
        <Heading bottom={4} level={5}>
          <i>(this is literally a wrapped div with some props- used where additional styling using Stitches [CSS] is needed)</i>
        </Heading>
        <Code copy>{"import { Element } from '@cosmo-au/design-system';"}</Code>
      </Element>
      <Element bottom={10} id='basic'>
        <Heading level={2}>Basic Usage</Heading>
        <Code copy>{"<Element css={{ verticalAlign: 'middle' }}>/*...children */</Element> \n"}</Code>
      </Element>
