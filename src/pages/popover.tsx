import { View, Element, Code, Box, Stack, Table, Text, Badge, Divider, TableHead, TableHeadCell, TableBody, TableRow, TableCell, Button, Popover } from '@cosmo-au/design-system';
        ...
        <Stack direction='row' flex='stretch'>
          <Stack direction='column'>
            <Box>
              ...
              <Element>
                <Code>{"import { Popover } from '@cosmo-au/design-system';"}</Code>
                <Code
                  css={{
                    paddingTop: '$3',
                  }}>
